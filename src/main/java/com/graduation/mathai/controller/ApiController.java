...
public class ApiController {
    ...
    public List<WrongQuestion> wrongQuestions(@RequestParam(value = "subject", required = false) String subject) {
        return wrongQuestionService.list(subject);
    }
    ...
    public WrongQuestion updateWrongQuestion(@PathVariable long id,
    ...
    @GetMapping("/analysis")
    public AnalysisResponse analysis(@RequestParam(value = "subject", required = false) String subject) {
        return wrongQuestionService.analyze(subject);
    }

    @PostMapping("/practice")
    public List<AiSolution> practice(@RequestParam(value = "subject", required = false) String subject) {
        return wrongQuestionService.generatePractice(subject);
    }
}
